...
public class Request implements Serializable {
    ...
    @OneToMany(mappedBy = "request")
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    private Set<Employee> performers = new HashSet<>();
    ...
    public Request performers(Set<Employee> employees) {
        this.performers = employees;
        return this;
    }

    public Request addPerformer(Employee employee) {
        this.performers.add(employee);
        employee.setRequest(this);
        return this;
    }

    public Request removePerformer(Employee employee) {
        this.performers.remove(employee);
        employee.setRequest(null);
        return this;
    }

    public void setPerformers(Set<Employee> employees) {
        this.performers = employees;
    }
